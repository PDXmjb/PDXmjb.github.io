...
export default function ProductPage() {
  ...
  return (
    <div className="exercise">
      ...
      <section className="exercise__workspace product">
        <h1>Products</h1>
        <button
          className="product__filter-button"
          type="button"
        ...
        <form
          className={`${isFiltersVisible ? 'product__filter' : 'product__filter product__filter--hidden'}`}
          id="filter"
